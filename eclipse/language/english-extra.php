...
$ECLIPSE_LANG_EXTRA = array(
    ...
    'content_bottom_title' => 'Content below the site content',
    'content_bottom_intro' => 'Add text or Geeklog autotags displayed below the main site content and before the right column.',
    'content_bottom_content' => 'Text or autotag',
    'content_bottom_help' => 'Plain text and any Geeklog autotag available on this site are accepted. Use autotags to insert links, images, videos, media or other dynamic content. Example: [autotag:parameter]. Leave empty to display nothing.',
