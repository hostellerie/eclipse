...
$ECLIPSE_LANG_EXTRA = array(
    ...
    'footer_legal_repurpose_help' => 'Copyright line and Legal notice now replace the first column of the standard footer instead of adding duplicate lines above it.',
    'commands' => 'Commands',
