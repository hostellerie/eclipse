...
function eclipse_theme_classes()
{
    ...
    $vividColors = array('#0067ff', '#004ec2', '#005bbb', '#f4f6fb', '#ffffff', '#202431');
    $currentColors = array($o['color_primary'], $o['color_secondary'], $o['color_link'], $o['color_background'], $o['color_surface'], $o['color_text']);
    if (array_map('strtolower', $currentColors) === $vividColors) $classes[] = 'palette-vivid-red';
